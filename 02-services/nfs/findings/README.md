...
[View NFS export evidence](../evidence/08_NFS02_nfs_export_root_to_all.png)
...
[View /etc/passwd disclosure evidence](../evidence/08_NFS04_nfs_passwd_disclosure.png)
...
[View sanitized /etc/shadow disclosure evidence](../evidence/08_NFS05_nfs_shadow_disclosure_%28REDACTED%29.png)
...
The assessment also tested whether the remotely mounted filesystem permitted file creation.
...
[View NFS write-access evidence](../evidence/08_NFS06_nfs_write_access.png)
...
[View NFS service identification evidence](../evidence/08_NFS01_nmap_nfs_detection.png)

[View mounted root filesystem evidence](../evidence/08_NFS03_nfs_root_filesystem_mounted.png)
...
[View NFS service detection evidence](../evidence/08_NFS01_nmap_nfs_detection.png)
...
[View sanitized /etc/shadow evidence](../evidence/08_NFS05_nfs_shadow_disclosure_%28REDACTED%29.png)

...
[View NFS export enumeration evidence](../evidence/08_NFS02_nfs_export_root_to_all.png)
...
[View mounted NFS root filesystem evidence](../evidence/08_NFS03_nfs_root_filesystem_mounted.png)
...
```text
08_NFS01_nmap_nfs_detection.png
08_NFS02_nfs_export_root_to_all.png
08_NFS03_nfs_root_filesystem_mounted.png
08_NFS04_nfs_passwd_disclosure.png
08_NFS05_nfs_shadow_disclosure_(REDACTED).png
08_NFS06_nfs_write_access.png
```
